...
def get_difference(edge1, edge2) -> tuple[list, list]:
    ...
    Parameters:
    * edge1: List - list of edges from the first graph
    * edge2: List - list of edges from the second graph

    Returns:
    * List: List of edges that are different between the two lists
    """
